    ...
    try:
        ...
        if bucket_rows:
            bucket_columns = (
                ...
                "margin_tier",
                "eliminated",
                "warming_window_no_conditions_met",
                "warming_window_no",
                "raw_research_candidate",
                ...
                "slippage_bps_yes_50",
                "slippage_bps_no_50",
                "taker_fee_per_share_yes_50",
                "taker_fee_per_share_no_50",
                "filled_fraction_yes_50",
                "filled_fraction_no_50",
                "executable_candidate_50",
                "executable_net_edge_50",
                "fill_yes_200",
                "fill_no_200",
                "slippage_bps_yes_200",
                "slippage_bps_no_200",
                "taker_fee_per_share_yes_200",
                "taker_fee_per_share_no_200",
                "filled_fraction_yes_200",
                "filled_fraction_no_200",
                "executable_candidate_200",
                "executable_net_edge_200",
                "fill_yes_1000",
                "fill_no_1000",
                "slippage_bps_yes_1000",
                "slippage_bps_no_1000",
                "taker_fee_per_share_yes_1000",
                "taker_fee_per_share_no_1000",
                "filled_fraction_yes_1000",
                "filled_fraction_no_1000",
                "executable_candidate_1000",
                "executable_net_edge_1000",
                "paper_alert_eligible",
                "edge_gate_blocked",
                "action",
            )
            connection.executemany(
                "INSERT INTO signal_bucket_observations ("
                + ",".join(bucket_columns)
                + ") VALUES ("
                + ",".join("?" * 57)
                + ") ON CONFLICT DO NOTHING",
